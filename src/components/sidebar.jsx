        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Rajesh Thokala</a></h1>
              <span className="email"><i className="icon-mail"></i> rajeshthokala10@gmail.com</span>
              <span className="phone"><i className="icon-phone"></i>+91-7026252122</span>
            </div>
